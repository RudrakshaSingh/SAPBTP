...
| 15  | Document Q&A API using RAG                   | Human Resources | RAG — FastAPI, in-memory similarity search  | [15-document-qa-rag-fastapi(for HON).md](<15-document-qa-rag-fastapi(for HON).md>)                     |
| 16  | Multi-Document Q&A with Source Filtering     | Enterprise KB   | RAG — chunk metadata, category filtering    | [16-multi-document-qa-source-filtering(for HON).md](<16-multi-document-qa-source-filtering(for HON).md>) |
| 17  | Conversational Q&A API with Memory           | Human Resources | Conversational RAG — sessions, query rewrite | [17-conversational-qa-memory(for HON).md](<17-conversational-qa-memory(for HON).md>)                   |
| 18  | Q&A API with Quality Check & Feedback        | Human Resources | RAG evaluation — groundedness, feedback loop | [18-qa-quality-check-feedback(for HON).md](<18-qa-quality-check-feedback(for HON).md>)                 |
